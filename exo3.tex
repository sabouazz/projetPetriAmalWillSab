...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
  ...
  \node[main node] (4) [below of=2]  [label=center:$\langle n\ \omega\ 1\ \omega\ \omega\ 0 \rangle$] {};
  \node[main node] (5) [below right of=2]  [label=center:$\langle
    n-1\ 2\ 1\ 0\ 1\ 0 \rangle$] {};
 \node[main node] (6) [above of = 3] [label=center:$\langle n\ 0\ 0\ 1\ 0\ 0 \rangle$] {} ;
  \node[main node] (7) [below left of=3]  [label=left:$\langle
    n-3\ 6\ 1\ 1\ 0\ 0 \rangle$] {};
 \node[main node] (8) [above  of=7]  [label=center:$\langle
   n-2\ 4\ 1\ 0\ 1\ 0 \rangle$] {};
  \node[main node] (9) [below right of=4]  [label=center:$\langle
    n\ 1\ 1\ 1\ 1\ 0 \rangle$] {?};
 \node[main node] (10) [below  of=4]  [label=center:$\langle
   n\ 1\ 1\ 1\ 1\ 0 \rangle$] {?};
 \node[main node] (11) [below left of=4]  [label=center:$\langle
   n\ 1\ 1\ 1\ 1\ 0 \rangle$] {?};
 \node[main node] (12) [above right of=9]  [label=center:$\langle n\ 1\ 1\ 1\ 1\ 0 \rangle$] {?};
  ...
  \path[every node/.style={font=\sffamily\small}]
   ...
   (4)   edge node [right] {$t_1$} (9)
         edge node [right] {$t_2$} (10)
         edge node [right] {$t_4$} (12)
         edge node [right] {$t_5$} (11);
